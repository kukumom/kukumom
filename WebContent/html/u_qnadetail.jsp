...
<%
	try {
		...
		String sql1 = "select A.Q_TITLE, B.USERNAME, C.PETNAME, A.Q_DATE, A.Q_CONTENT, D.HOSNAME , A.QNAREPLY FROM USRQNA A LEFT JOIN USRINFO B ON A.USERID=B.USERID LEFT JOIN USRPET C ON A.PETCODE=C.PETCODE LEFT JOIN HOSINFO D ON A.HOSCODE=D.HOSCODE where A.USERID= 'kukumom3'";
