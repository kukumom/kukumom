...
<%
  ...
  try {
    ...
    String sql = "select userid, userpw, username from board order by idx desc";
...
<%
        ...
        while(rs.next()){
            ...
            out.print("<td> <a href='a_content.jsp?idx="+ rs.getString("userid") +"'>" + rs.getString("userpw") + rs.getString("username") + " </a></td>");
